...
void CLCD_voidInit        ( void ){
	...
	// 1- must wait more than 30 ms before any action (VDD rises to 4.5 v)
	_delay_ms(50);
	DIO_enuSetPinConfiguration      (CLCD_DATA_PORT,DIO_enuPin4,DIO_enuOutput);
	DIO_enuSetPinConfiguration      (CLCD_DATA_PORT,DIO_enuPin5,DIO_enuOutput);
	DIO_enuSetPinConfiguration      (CLCD_DATA_PORT,DIO_enuPin6,DIO_enuOutput);
	DIO_enuSetPinConfiguration      (CLCD_DATA_PORT,DIO_enuPin7,DIO_enuOutput);
	DIO_enuSetPinConfiguration  ( CLCD_CONTROL_PORT , CLCD_RS , DIO_enuOutput  );
	DIO_enuSetPinConfiguration  ( CLCD_CONTROL_PORT , CLCD_RW , DIO_enuOutput  );
	DIO_enuSetPinConfiguration  ( CLCD_CONTROL_PORT , CLCD_EN , DIO_enuOutput  );
	...
	CLCD_voidSendCommand( EIGHT_BITS ); // 4 Bit Mode ==> 0x28
	_delay_ms(1); // wait more than 39 Ms
...
void CLCD_voidSendData    ( u8 Copy_u8Data ){
	...
	DIO_enuSetPinValue  ( CLCD_CONTROL_PORT , CLCD_RS , DIO_enuHigh );
	DIO_enuSetPinValue  ( CLCD_CONTROL_PORT , CLCD_RW , DIO_enuLow  );
...
void CLCD_voidSendCommand ( u8  Copy_u8Command ){
	...
	DIO_enuSetPinValue  ( CLCD_CONTROL_PORT , CLCD_RS , DIO_enuLow  );
...
{
	DIO_enuSetPinValue  ( CLCD_CONTROL_PORT , CLCD_EN , DIO_enuHigh );
	_delay_ms(1);
	DIO_enuSetPinValue  ( CLCD_CONTROL_PORT , CLCD_EN , DIO_enuLow  );
	_delay_ms(1);
}

 ...
 *
 */
DIO_enuErrorStatus_t DIO_voidWriteHighNibbles(u8 Copy_u8PORT,u8 Copy_u8value)
{

	DIO_enuErrorStatus_t LOC_enumState = DIO_enuOk ;

	if ( (Copy_u8PORT <= DIO_enuPORTD))
	{
		Copy_u8value = (Copy_u8value<<4) ;
		switch(Copy_u8PORT)
		{
		case DIO_enuPORTA :
			PORTA_REG&=0x0f;                   // make sure the high bits = 0000
			PORTA_REG|=Copy_u8value;			//Set only the high nibble of the port A by the given value
			break ;
		case DIO_enuPORTB:
			PORTB_REG&=0x0f;                 //Set only the high nibble of the port B by the given value
			PORTB_REG|=Copy_u8value;
			break ;
		case DIO_enuPORTC :
			PORTC_REG&=0x0f;                 //Set only the high nibble of the port C by the given value
			PORTC_REG|=Copy_u8value;
			break ;
		case DIO_enuPORTD:
			PORTD_REG&=0x0f;                 //Set only the high nibble of the port D by the given value
			PORTD_REG|=Copy_u8value;
			break ;
		default: break ;
 ...
 *
 */
DIO_enuErrorStatus_t DIO_voidWriteLowNibbles(u8 Copy_u8PORT,u8 Copy_u8value)
{
	DIO_enuErrorStatus_t LOC_enumState = DIO_enuOk ;
